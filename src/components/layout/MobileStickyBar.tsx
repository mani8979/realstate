      ...
      <div className="mx-4 mb-6">
        <div className="bg-black/80 backdrop-blur-2xl border border-white/20 rounded-[2rem] p-2 flex items-center justify-between shadow-[0_-10px_40px_rgba(0,0,0,0.5)] ring-1 ring-white/10">
          ...
          <button 
            ...
            className="flex-1 bg-primary text-white py-3 px-4 rounded-[1.5rem] flex items-center justify-center gap-2 shadow-lg shadow-primary/30 transform active:scale-95 transition-transform"
          >
            <Calendar size={18} />
