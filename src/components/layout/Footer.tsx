      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="border-t border-white/5 pt-12 text-center space-y-3">
          ...
          <div className="flex items-center justify-center gap-2">
            ...
            {/* WhatsApp Icon next to name */}
            <a
              href="https://wa.me/919581108448"
              target="_blank"
              rel="noopener noreferrer"
              title="Chat with Kalla Manibabu on WhatsApp"
              className="inline-flex items-center justify-center w-5 h-5 rounded-full bg-[#25D366]/10 hover:bg-[#25D366] text-[#25D366] hover:text-white transition-all duration-300 hover:scale-110 shadow-sm hover:shadow-[#25D366]/30 hover:shadow-lg shrink-0"
            >
