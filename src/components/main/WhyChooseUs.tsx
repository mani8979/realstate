              ...
              {features.map((feature, index) => (
                ...
                >
                  ...
                  <div>
                    ...
                    <h4 className="text-sm md:text-xl lg:text-2xl font-black text-slate-900 dark:text-white mb-2 sm:mb-3 uppercase tracking-tight leading-tight w-full break-words">
                      {feature.title}
                    </h4>
