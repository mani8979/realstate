  ...
  return (
    <section className="py-24 md:py-32 relative overflow-x-hidden">
      <div className="container mx-auto px-4 md:px-6">
        <div className="relative rounded-[2.5rem] md:rounded-[4rem] overflow-hidden bg-slate-50 dark:bg-slate-900 p-8 md:p-32 text-center border border-white/20 shadow-[0_30px_100px_rgba(0,0,0,0.5)]">
          ...
          <div className="relative z-10 max-w-4xl mx-auto">
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/10 border border-white/20 text-primary mb-6 md:mb-8 backdrop-blur-md">
            ...
            <h2 className="text-4xl md:text-8xl font-black text-white mb-6 md:mb-10 leading-[1.1] md:leading-[0.9] tracking-tighter uppercase whitespace-pre-line">
               {content?.ctaSectionTitle || 'Ready to claim\nyour Signature land?'}
            </h2>
            
            <p className="text-base md:text-2xl text-gray-200 mb-10 md:mb-16 leading-relaxed max-w-2xl mx-auto font-medium">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 md:gap-6">
              <button
                ...
                className="w-full sm:w-auto bg-primary hover:bg-white text-white hover:text-black font-black px-8 md:px-12 py-5 md:py-6 rounded-2xl transition-all flex items-center justify-center gap-3 group shadow-2xl shadow-primary/20 uppercase tracking-widest text-[10px] md:text-xs"
              >
              ...
              <a
                ...
                className="w-full sm:w-auto bg-white/10 hover:bg-black/10 dark:bg-white/10 text-white font-black px-8 md:px-12 py-5 md:py-6 rounded-2xl border border-white/20 transition-all flex items-center justify-center gap-3 backdrop-blur-md uppercase tracking-widest text-[10px] md:text-xs group"
              >
