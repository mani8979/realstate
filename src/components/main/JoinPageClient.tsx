            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-20">
              ...
              <div className="space-y-10">
                ...
                <button 
                  ...
                  className="inline-flex items-center gap-4 bg-white/5 border border-white/10 text-white px-10 py-5 rounded-2xl font-black uppercase tracking-widest text-xs hover:bg-primary hover:border-primary transition-all transform hover:scale-105 shadow-2xl"
                >
                  <Users size={20} />
