    ...
    <section className="bg-black text-white py-24 md:py-32 overflow-hidden">
      <div className="container mx-auto px-6">
        ...
        <motion.h2 
          ...
          viewport={{ once: true }}
          className="text-[60px] md:text-[120px] font-black text-center uppercase tracking-tighter leading-none mb-20 md:mb-32"
        >
          {content?.getInTouchTitle || 'GET IN TOUCH'}
        </motion.h2>

        <div className="grid grid-cols-1 md:grid-cols-2 gap-16 md:gap-32 items-start max-w-6xl mx-auto border-t border-white/10 pt-20">
          {/* Inquiries */}
          <motion.div 
          ...
          >
            ...
            <div className="space-y-8">
              <h3 className="text-2xl md:text-4xl font-black leading-tight tracking-tight max-w-md">
