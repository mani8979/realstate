    ...
    <div className="space-y-10">
      <div className="flex items-center justify-between">
        ...
        <Link 
          ...
          className="bg-primary hover:bg-primary-dark text-black dark:text-white font-bold px-6 py-3 rounded-xl flex items-center gap-2 transition-all shadow-lg shadow-primary/20"
        >
          <PlusCircle size={20} />
          ...
          <table className="w-full text-left">
            <thead>
              <tr className="bg-gray-50 dark:bg-gray-800/50">
                <th className="px-8 py-5 text-sm font-bold text-gray-600 dark:text-gray-400 uppercase tracking-widest">Name</th>
                <th className="px-8 py-5 text-sm font-bold text-gray-600 dark:text-gray-400 uppercase tracking-widest">Phone</th>
                <th className="px-8 py-5 text-sm font-bold text-gray-600 dark:text-gray-400 uppercase tracking-widest">Property</th>
                <th className="px-8 py-5 text-sm font-bold text-gray-600 dark:text-gray-400 uppercase tracking-widest text-right">Date</th>
              </tr>
            </thead>
