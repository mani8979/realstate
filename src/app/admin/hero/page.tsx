  ...
  return (
    <div className="max-w-4xl">
      <div className="flex justify-between items-center mb-8">
        <h1 className="text-3xl font-black uppercase text-gray-900 dark:text-black dark:text-white">Hero Settings</h1>
        <button 
          onClick={handleSave}
          disabled={saving}
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 border-t border-gray-100 dark:border-gray-800 pt-4">
              <div>
                ...
                <input name="heroCta2Text" value={content.heroCta2Text || ''} onChange={handleChange} className="w-full p-4 rounded-xl border border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-800 text-gray-900 dark:text-black dark:text-white font-medium" />
              </div>
              <div>
                <label className="block text-sm font-bold text-gray-500 mb-2">CTA 2 Link (Optional)</label>
                <input name="heroCta2Link" value={content.heroCta2Link || ''} onChange={handleChange} className="w-full p-4 rounded-xl border border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-800 text-gray-900 dark:text-black dark:text-white font-medium" />
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 border-t border-gray-100 dark:border-gray-800 pt-4">
              <div>
                ...
                <input name="heroCta3Text" value={content.heroCta3Text || ''} onChange={handleChange} className="w-full p-4 rounded-xl border border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-800 text-gray-900 dark:text-black dark:text-white font-medium" />
              </div>
              <div>
                <label className="block text-sm font-bold text-gray-500 mb-2">CTA 3 Link (Group/Updates Link)</label>
                <input name="heroCta3Link" value={content.heroCta3Link || ''} onChange={handleChange} className="w-full p-4 rounded-xl border border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-800 text-gray-900 dark:text-black dark:text-white font-medium" />
              </div>
            </div>
          </div>
        </div>
