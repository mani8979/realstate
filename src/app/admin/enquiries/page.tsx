              ...
              <div className="flex flex-col md:flex-row md:items-start justify-between gap-6">
                <div className="space-y-4 flex-grow">
                  ...
                  {enquiry.propertyTitle && (
                    <div className="flex items-center gap-2">
                      <span className="text-xs font-bold text-gray-400 uppercase tracking-widest">Interested In:</span>
                ...
                <div className="flex flex-row md:flex-col gap-2">
                  <a 
                    ...
                    className="flex-grow flex items-center justify-center gap-2 bg-primary text-white font-bold px-6 py-3 rounded-xl hover:bg-primary-dark transition-all"
                  >
                    <Phone size={18} />
                    <span>Call Lead</span>
                  </a>
